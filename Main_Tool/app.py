...
df17 = pd.read_csv("Moonboard-Holds-main/Main_Tool/Data/Analysis_Data2017")
df19 = pd.read_csv("Moonboard-Holds-main/Main_Tool/Data/Analysis_Data2019")
df16 = pd.read_csv("Moonboard-Holds-main/Main_Tool/Data/Analysis_Data2016")
...
if user_set == "2017":
    year = df17
    st.image("Moonboard-Holds-main/Main_Tool/Set_Images/mbsetup-mbm2017.jpg", width=500)
elif user_set == "2019":
    year = df19
    st.image("Moonboard-Holds-main/Main_Tool/Set_Images/mbsetup-mbm2019.jpg", width=500)
else:
    year = df16
    st.image("Moonboard-Holds-main/Main_Tool/Set_Images/mbsetup-2016.jpg", width=500)
